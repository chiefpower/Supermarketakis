...
if ($_SESSION['logged_in'] ?? false) {
    ...
    // Logged in and is an employee — stay on this page
} else {
    // Not logged in
    header('Location: redirect-helper.php?redirectTo=dashboard.php');
...
<html lang="en">
  <head>
    <title>Supermarketakis - Dashboard</title>
    <meta charset="utf-8">
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasSearch" aria-labelledby="Search">
      ...
      <div class="offcanvas-body">
        <div class="order-md-last">
          ...
          <form role="search" action="#tsian02" method="get" class="d-flex mt-3 gap-0">
          ...
          <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
            <div class="search-bar row bg-light p-2 my-2 rounded-4">
              ...
              <div class="col-11 col-md-7">
                <form id="search-form" class="text-center" action="#tsian02" method="post">
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                      <div class="col">
                        <div class="product-item">
                          ...
                          <figure>
                            <a href="#tsian02" title="<?= htmlspecialchars($row['name']) ?>">

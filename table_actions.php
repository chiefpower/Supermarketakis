...
<div class='d-flex justify-content-center gap-2 mb-3'>
  <button class='btn btn-sm btn-success' id='add-new-row'>Add New Row</button>
  <button class='btn btn-sm btn-success' id='edit-selected' disabled>Edit Selected</button>
  <button class='btn btn-sm btn-danger' id='delete-selected' disabled>Delete Selected</button>
</div>
";

echo "<table class='table table-bordered table-sm bg-white'><thead><tr>";

// Add a header cell for the checkboxes
